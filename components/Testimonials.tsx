    ...
    >
      ...
      <div className="max-w-6xl mx-auto mt-20 px-4 text-center">
        ...
        >
          ...
          >
            Join <span className="text-[#118c90]">1,500+ Happy Patients</span>{" "}
            Who Trust Us.
          ...
          >
            Say Goodbye to Dental Pain For Good.
          </motion.h2>
          ...
          >
            Our three-step process relieves pain, restores your smile, and
